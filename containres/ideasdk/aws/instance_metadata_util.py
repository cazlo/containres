...
from containres.ideasdk.protocols import InstanceMetadataUtilProtocol
from containres.ideadatamodel import exceptions, errorcodes, EC2InstanceIdentityDocument
