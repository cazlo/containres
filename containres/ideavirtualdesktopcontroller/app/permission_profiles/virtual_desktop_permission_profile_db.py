...
from containres.ideadatamodel import exceptions, VirtualDesktopPermissionProfile, ListPermissionProfilesRequest, ListPermissionProfilesResponse, SocaPaginator, VirtualDesktopPermission
from containres.ideasdk.utils import Utils
from containres.ideavirtualdesktopcontroller.app.permission_profiles import constants as permission_profiles_constants
...
class VirtualDesktopPermissionProfileDB(VirtualDesktopNotifiableDB):
    ...
    def __init__(self, context: containres.ideavirtualdesktopcontroller.AppContext):
        ...
        self.BASE_PERMISSIONS_CONFIG_FILE = f'{os.path.join(os.path.dirname(__file__), "config")}/permission-config.yaml'
        self.BASE_PERMISSION_PROFILE_CONFIG_FILE = f'{os.path.join(os.path.dirname(__file__), "config")}/base-permission-profile-config.yaml'
