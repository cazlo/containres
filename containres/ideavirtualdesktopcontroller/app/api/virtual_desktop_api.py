...
from containres.ideadatamodel import exceptions
from containres.ideadatamodel import constants
from containres.ideasdk.api import (
    ApiInvocationContext,
    BaseAPI
)
from containres.ideasdk.context import ArnBuilder
...
from containres.ideavirtualdesktopcontroller.app.session_permissions.constants import SESSION_PERMISSIONS_FILTER_SESSION_ID_KEY, SESSION_PERMISSIONS_FILTER_ACTOR_KEY
...
class VirtualDesktopAPI(BaseAPI):
    ...
    def __init__(self, context: containres.ideavirtualdesktopcontroller.AppContext):
