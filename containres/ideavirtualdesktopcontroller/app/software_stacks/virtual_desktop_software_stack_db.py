...
from containres.ideadatamodel.virtual_desktop.virtual_desktop_model import VirtualDesktopGPU
...
from containres.ideavirtualdesktopcontroller.app.software_stacks import constants as software_stacks_constants
...
class VirtualDesktopSoftwareStackDB(VirtualDesktopNotifiableDB):
    ...
    def __init__(self, context: containres.ideavirtualdesktopcontroller.AppContext):
        ...
        self.BASE_STACKS_CONFIG_FILE = f'{os.path.join(os.path.dirname(__file__), "config")}/base-software-stack-config.yaml'
