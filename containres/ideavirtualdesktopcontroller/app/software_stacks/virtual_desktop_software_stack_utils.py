...
from containres.ideadatamodel import VirtualDesktopSoftwareStack, VirtualDesktopSession
...
class VirtualDesktopSoftwareStackUtils:
    ...
    def __init__(self, context: containres.ideavirtualdesktopcontroller.AppContext, db: VirtualDesktopSoftwareStackDB):
