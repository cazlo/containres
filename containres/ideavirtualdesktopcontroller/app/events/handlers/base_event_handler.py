...
from containres.ideavirtualdesktopcontroller.app.app_protocols import VirtualDesktopQueueMessageHandlerProtocol
from containres.ideavirtualdesktopcontroller.app.clients.dcv_broker_client.dcv_broker_client_utils import DCVBrokerClientUtils
from containres.ideavirtualdesktopcontroller.app.clients.events_client.events_client import VirtualDesktopEvent
from containres.ideavirtualdesktopcontroller.app.events.events_utils import EventsUtils
from containres.ideavirtualdesktopcontroller.app.permission_profiles.virtual_desktop_permission_profile_db import VirtualDesktopPermissionProfileDB
from containres.ideavirtualdesktopcontroller.app.schedules.virtual_desktop_schedule_db import VirtualDesktopScheduleDB
from containres.ideavirtualdesktopcontroller.app.schedules.virtual_desktop_schedule_utils import VirtualDesktopScheduleUtils
from containres.ideavirtualdesktopcontroller.app.servers.virtual_desktop_server_db import VirtualDesktopServerDB
from containres.ideavirtualdesktopcontroller.app.servers.virtual_desktop_server_utils import VirtualDesktopServerUtils
from containres.ideavirtualdesktopcontroller.app.session_permissions.virtual_desktop_session_permission_db import VirtualDesktopSessionPermissionDB
from containres.ideavirtualdesktopcontroller.app.session_permissions.virtual_desktop_session_permission_utils import VirtualDesktopSessionPermissionUtils
from containres.ideavirtualdesktopcontroller.app.sessions.virtual_desktop_session_counters_db import VirtualDesktopSessionCounterDB
from containres.ideavirtualdesktopcontroller.app.sessions.virtual_desktop_session_db import VirtualDesktopSessionDB
from containres.ideavirtualdesktopcontroller.app.sessions.virtual_desktop_session_utils import VirtualDesktopSessionUtils
from containres.ideavirtualdesktopcontroller.app.software_stacks.virtual_desktop_software_stack_db import VirtualDesktopSoftwareStackDB
from containres.ideavirtualdesktopcontroller.app.software_stacks.virtual_desktop_software_stack_utils import VirtualDesktopSoftwareStackUtils
from containres.ideavirtualdesktopcontroller.app.ssm_commands.virtual_desktop_ssm_commands_db import VirtualDesktopSSMCommandsDB
from containres.ideavirtualdesktopcontroller.app.ssm_commands.virtual_desktop_ssm_commands_utils import VirtualDesktopSSMCommandsUtils
from containres.ideavirtualdesktopcontroller.app.virtual_desktop_controller_utils import VirtualDesktopControllerUtils


class BaseVirtualDesktopControllerEventHandler(VirtualDesktopQueueMessageHandlerProtocol):

    def __init__(self, context: containres.ideavirtualdesktopcontroller.AppContext, logger_prefix: str):
