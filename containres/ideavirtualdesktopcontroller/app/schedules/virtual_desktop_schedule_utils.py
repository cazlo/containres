...
from containres.ideadatamodel import VirtualDesktopSession, DayOfWeek, VirtualDesktopSchedule, VirtualDesktopScheduleType, VirtualDesktopWeekSchedule
...
class VirtualDesktopScheduleUtils:
    def __init__(self, context: containres.ideavirtualdesktopcontroller.AppContext, db: VirtualDesktopScheduleDB):
