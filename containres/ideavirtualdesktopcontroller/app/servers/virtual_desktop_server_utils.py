...
from containres.ideadatamodel import VirtualDesktopServer, VirtualDesktopSession
...
class VirtualDesktopServerUtils:
    def __init__(self, context: containres.ideavirtualdesktopcontroller.AppContext, db: VirtualDesktopServerDB):
