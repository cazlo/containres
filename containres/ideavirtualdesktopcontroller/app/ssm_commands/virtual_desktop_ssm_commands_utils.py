...
from containres.ideadatamodel import VirtualDesktopBaseOS
from containres.ideasdk.utils import Utils
from containres.ideavirtualdesktopcontroller.app.ssm_commands.virtual_desktop_ssm_commands_db import VirtualDesktopSSMCommandsDB, VirtualDesktopSSMCommand, VirtualDesktopSSMCommandType


class VirtualDesktopSSMCommandsUtils:
    def __init__(self, context: containres.ideavirtualdesktopcontroller.AppContext, db: VirtualDesktopSSMCommandsDB):
