...
from containres.ideavirtualdesktopcontroller.app.app_protocols import VirtualDesktopNotifiableDBProtocol
from containres.ideavirtualdesktopcontroller.app.clients.events_client.events_client import VirtualDesktopEvent, VirtualDesktopEventType


class VirtualDesktopNotifiableDB(VirtualDesktopNotifiableDBProtocol):
    def __init__(self, context: containres.ideavirtualdesktopcontroller.AppContext, table_name: str, logger: Logger):
