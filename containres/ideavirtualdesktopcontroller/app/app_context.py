...
from containres.ideasdk.client import NotificationsAsyncClient, ProjectsClient, AccountsClient
...
class VirtualDesktopControllerAppContext(SocaContext):
    ...
    def get_resources_dir(self) -> str:
        if Utils.is_true(EnvironmentUtils.idea_dev_mode(), False):
            ...
            # todo need to copy over all these static resources and fix relative references
