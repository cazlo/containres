...
from containres.ideadatamodel import VirtualDesktopSessionPermission, VirtualDesktopSession, VirtualDesktopBaseOS, UpdateSessionPermissionRequest, UpdateSessionPermissionResponse
...
class VirtualDesktopSessionPermissionUtils:
    ...
    def __init__(self, context: containres.ideavirtualdesktopcontroller.AppContext, db: VirtualDesktopSessionPermissionDB, permission_profile_db: VirtualDesktopPermissionProfileDB):
