...
from containres.ideadatamodel import VirtualDesktopSession, VirtualDesktopServer, VirtualDesktopSessionState
from containres.ideasdk.utils import Utils, DateTimeUtils
...
class VirtualDesktopSessionUtils:
    def __init__(self, context: containres.ideavirtualdesktopcontroller.AppContext, db: VirtualDesktopSessionDB, session_permission_db: VirtualDesktopSessionPermissionDB, permission_profile_db: VirtualDesktopPermissionProfileDB):
