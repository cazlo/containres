...
from containres.ideasdk.config.cluster_config_db import ClusterConfigDB
from containres.ideasdk.config.cluster_config import ClusterConfig
from containres.ideasdk.config.soca_config import SocaConfig
from containres.ideasdk.context import SocaCliContext, SocaContextOptions

import containres.ideaadministrator
from containres.ideaadministrator import app_constants
from containres.ideaadministrator.app_utils import AdministratorUtils
from containres.ideaadministrator.app.installer_params import QuickSetupPromptFactory
from containres.ideaadministrator.app_props import AdministratorProps
from containres.ideaadministrator.app.cdk.cdk_invoker import CdkInvoker
from containres.ideaadministrator.app.config_generator import ConfigGenerator
from containres.ideaadministrator.app.delete_cluster import DeleteCluster
from containres.ideaadministrator.app.patch_helper import PatchHelper
from containres.ideaadministrator.app.deployment_helper import DeploymentHelper
from containres.ideaadministrator.integration_tests.test_context import TestContext
from containres.ideaadministrator.integration_tests.test_invoker import TestInvoker
from containres.ideaadministrator.app.values_diff import ValuesDiff
from containres.ideaadministrator.app.vpc_endpoints_helper import VpcEndpointsHelper
from containres.ideaadministrator.app.aws_service_availability_helper import AwsServiceAvailabilityHelper
from containres.ideaadministrator.app.cluster_prefix_list_helper import ClusterPrefixListHelper
from containres.ideaadministrator.app.support_helper import SupportHelper
from containres.ideaadministrator.app.directory_service_helper import DirectoryServiceHelper
from containres.ideaadministrator.app.shared_storage_helper import SharedStorageHelper
...
@click.version_option(version=containres.ideaadministrator.__version__)
def main():
    """
...
def config_generate(values_file: str, config_dir: str, force: bool, existing_resources: bool = False, regenerate: bool = False):
    ...
    if Utils.is_empty(values_file):
        ...
        param_registry = SocaUserInputParamRegistry(
            context=context,
            file=containres.ideaadministrator.props.install_params_file
        )
...
def cdk_app(cluster_name, aws_profile, aws_region, module_name, module_id, deployment_id, termination_protection):
    ...
    cdk app
    """
    from containres.ideaadministrator.app.cdk.cdk_app import CdkApp
    CdkApp(
        cluster_name=cluster_name,
        aws_profile=aws_profile,
        aws_region=aws_region,
...
def quick_setup_help():
    ...
    """
    values_file = containres.ideaadministrator.props.default_values_file
    with open(values_file, 'r') as f:
        content = f.read()
    print(content)
...
def about(no_banner: bool):
    ...
    if no_banner:
        tokens = [
            ...
            f'Version: v{containres.ideaadministrator.__version__}'
        ]
        if dev_mode:
        ...
        context = SocaCliContext()
        meta_info = [
            SocaKeyValue(key='Version', value=containres.ideaadministrator.__version__)
        ]
        if dev_mode:
