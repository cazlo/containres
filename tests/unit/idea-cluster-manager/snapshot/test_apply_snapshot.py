...
from containres.ideaclustermanager.app.snapshots.apply_snapshot import ApplySnapshot
...
from containres.ideaclustermanager.app.snapshots.apply_snapshot_merge_table.merge_table import (
    MergeTable,
)
from containres.ideaclustermanager.app.snapshots.helpers.apply_snapshot_version_control_helper import (
    get_table_keys_by_res_version,
)
from containres.ideaclustermanager.app.snapshots.helpers.apply_snapshots_config import (
    RES_VERSION_TO_DATA_TRANSFORMATION_CLASS,
    TABLE_TO_TABLE_KEYS_BY_VERSION,
)
from containres.ideaclustermanager.app.snapshots.helpers.merged_record_utils import (
    MergedRecordDelta,
)
from containres.ideaclustermanager.app.snapshots.snapshot_constants import (
    TABLE_EXPORT_DESCRIPTION_KEY,
    VERSION_KEY,
)
from containres.ideasdk.context import SocaContext

from containres.ideadatamodel import errorcodes, exceptions
from containres.ideadatamodel.snapshots import RESVersion, Snapshot, TableKeys, TableName
...
class ApplySnapshotsTest(unittest.TestCase):
    def setUp(self) -> None:
        self.monkeypatch.setattr(
            "containres.ideaclustermanager.app.snapshots.apply_snapshot.TableName", DummyTableName
        )
        self.monkeypatch.setattr(
            "containres.ideaclustermanager.app.snapshots.helpers.apply_snapshot_version_control_helper.TableName",
            DummyTableName,
        )
        self.monkeypatch.setattr(
            "containres.ideaclustermanager.app.snapshots.helpers.apply_snapshot_version_control_helper.RESVersion",
            DummyResVersion,
        )
        self.monkeypatch.setattr(
            "containres.ideaclustermanager.app.snapshots.apply_snapshot.RES_VERSION_IN_TOPOLOGICAL_ORDER",
            DUMMY_RES_VERSION_IN_TOPOLOGICAL_ORDER,
        )
        self.monkeypatch.setattr(
            "containres.ideaclustermanager.app.snapshots.helpers.apply_snapshot_version_control_helper.RES_VERSION_IN_TOPOLOGICAL_ORDER",
            DUMMY_RES_VERSION_IN_TOPOLOGICAL_ORDER,
        )
        self.monkeypatch.setattr(
            "containres.ideaclustermanager.app.snapshots.helpers.apply_snapshot_version_control_helper.TABLE_TO_TABLE_KEYS_BY_VERSION",
            DUMMY_TABLE_TO_TABLE_KEYS_BY_VERSION,
        )
        self.monkeypatch.setattr(
            "containres.ideaclustermanager.app.snapshots.apply_snapshot.RES_VERSION_TO_DATA_TRANSFORMATION_CLASS",
            DUMMY_RES_VERSION_TO_DATA_TRANSFORMATION_CLASS,
        )
        self.monkeypatch.setattr(
            "containres.ideaclustermanager.app.snapshots.apply_snapshot.TABLES_IN_MERGE_DEPENDENCY_ORDER",
            DUMMY_TABLES_IN_MERGE_DEPENDENCY_ORDER,
        )
        self.monkeypatch.setattr(
            ApplySnapshot,
    ...
    def test_apply_snapshot_merge_function_succeeds(self):
        ...
        self.monkeypatch.setattr(
            "containres.ideaclustermanager.app.snapshots.apply_snapshot.TABLE_TO_MERGE_LOGIC_CLASS",
            DUMMY_TABLE_TO_MERGE_LOGIC_CLASS_MERGE_FAIL_TEST,
        )
